...
import com.mygdx.mariobrosclone.Sprites.InteractiveTileObject;
...
public class WorldContactListner implements ContactListener {
	...
	public void beginContact(Contact contact) {
		...
		case MarioBrosClone.MARIO_HEAD_BIT | MarioBrosClone.COIN_BIT:
			if(fixA.getFilterData().categoryBits == MarioBrosClone.BRICK_BIT || fixA.getFilterData().categoryBits == MarioBrosClone.COIN_BIT)
