...
public class Mario extends Sprite{
	...
	public void createMario()
	{
		...
		fdef.filter.maskBits = MarioBrosClone.GROUND_BIT | MarioBrosClone.BRICK_BIT | 
				MarioBrosClone.COIN_BIT | MarioBrosClone.ENEMY_BIT |
				MarioBrosClone.OBJECT_BIT | MarioBrosClone.ENEMY_HEAD_BIT | MarioBrosClone.ITEM_BIT ;
		
		fdef.shape = shape;
		b2body.createFixture(fdef).setUserData(this);
		EdgeShape head = new EdgeShape();
		head.set(new Vector2(-2/MarioBrosClone.PPM,  6/MarioBrosClone.PPM), new Vector2(2/MarioBrosClone.PPM,  6/MarioBrosClone.PPM));
		fdef.shape = head;
		fdef.isSensor = true;
	...
	public void update(float dt)
	{
		if(marioIsBig)//|| runShrinkAnimation
			setPosition(b2body.getPosition().x - getWidth()/2, b2body.getPosition().y - getHeight()/2 - 6/MarioBrosClone.PPM);
		else
